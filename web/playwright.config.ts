...
const useSingleProcess = process.env.PLAYWRIGHT_SINGLE_PROCESS === "1";
...
export default defineConfig({
  ...
  workers: useSingleProcess ? 64 : process.env.CI ? 2 : 1,
  reporter: process.env.CI ? [["line"], ["html", { open: "never" }]] : "line",
  use: {
    baseURL: "http://127.0.0.1:4173",
    channel: useBundledChromium ? undefined : "chrome",
    launchOptions: useSingleProcess ? { args: ["--single-process"] } : undefined,
