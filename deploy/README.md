...
and execution. Each compile starts a fresh Node 26.10.0 SEA subprocess with a minimal
...
stage contains the application binary plus one read-only Node 26.10.0 SEA, its
