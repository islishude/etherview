...
if (
  selfTest.status !== 0 ||
  selfTest.stdout !==
    '{"schema":"etherview-solcjs-sea-self-test-v1","sea":true,"node_version":"v26.10.0","wrapper_package":"solc@0.8.37","exec_argv":["--permission","--disable-sigusr1","--no-addons","--no-global-search-paths","--max-old-space-size=384"],"permissions":"restricted","write_denied":true}'
) {
  throw new Error(
