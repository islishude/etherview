...
var catalog = []Spec{
	...
	spec("rotateCurrentUserAPIKey", "POST", "/users/me/api-keys/{prefix}/rotate", false,
		pathParameter("prefix", ParameterText)),
	spec("revokeCurrentUserAPIKey", "DELETE", "/users/me/api-keys/{prefix}", false,
		pathParameter("prefix", ParameterText)),
	...
	spec("getCurrentBillingAccount", "GET", "/billing/account", false),
	spec("listCurrentBillingTopupIntents", "GET", "/billing/topup-intents", false,
		cursorParameter(), limitParameter("25")),
	spec("createBillingTopupIntent", "POST", "/billing/topup-intents", false),
	spec("getBillingTopupIntent", "GET", "/billing/topup-intents/{id}", false,
		pathParameter("id", ParameterUUID)),
	spec("payBillingTopupIntent", "POST", "/billing/topup-intents/{id}/pay", false,
		pathParameter("id", ParameterUUID)),
	spec("listCurrentUserBillingUsage", "GET", "/billing/usage", false,
		cursorParameter(), limitParameter("25")),
	...
	spec("getAdminBillingSummary", "GET", "/admin/billing/summary", false,
		...
		queryParameter("state", ParameterBillingState),
		queryParameter("to_time", ParameterRFC3339)),
	spec("listAdminBillingAccounts", "GET", "/admin/billing/accounts", false,
		cursorParameter(), limitParameter("25")),
	spec("adjustAdminBillingAccount", "POST", "/admin/billing/accounts/{id}/adjustments", false,
		pathParameter("id", ParameterUUID)),
	spec("listAdminBillingTopups", "GET", "/admin/billing/topups", false,
		cursorParameter(), limitParameter("25")),
	spec("listAdminBillingUsage", "GET", "/admin/billing/usage", false,
		cursorParameter(), limitParameter("25")),
	spec("getAdminPrepaidBillingSummary", "GET", "/admin/billing/prepaid-summary", false),
	spec("listBlocks", "GET", "/blocks", true,
		cursorParameter(), limitParameter("25")),
	spec("getBlock", "GET", "/blocks/{id}", true,
		pathParameter("id", ParameterBlockIdentifier)),
	spec("listBlockTransactions", "GET", "/blocks/{id}/transactions", true,
		pathParameter("id", ParameterBlockIdentifier),
		cursorParameter(), limitParameter("25")),
	spec("listTransactions", "GET", "/transactions", true,
		cursorParameter(), limitParameter("25")),
	spec("listUserOperations", "GET", "/user-operations", true,
		cursorParameter(), limitParameter("25")),
	spec("getUserOperation", "GET", "/user-operations/{hash}", true,
	...
	spec("getTransactionCalldata", "GET", "/transactions/{hash}/calldata", true,
		pathParameter("hash", ParameterHash)),
	spec("getTransactionFailure", "GET", "/transactions/{hash}/failure", true,
		pathParameter("hash", ParameterHash)),
	spec("listPendingTransactions", "GET", "/pending", true,
		cursorParameter(), limitParameter("25")),
	spec("getTransactionTrace", "GET", "/transactions/{hash}/trace", true,
		pathParameter("hash", ParameterHash)),
	spec("listTransactionUserOperations", "GET", "/transactions/{hash}/user-operations", true,
		pathParameter("hash", ParameterHash),
		cursorParameter(), limitParameter("25")),
	spec("listTransactionInternalTransactions", "GET", "/transactions/{hash}/internal-transactions", true,
		pathParameter("hash", ParameterHash),
		cursorParameter(), limitParameter("25")),
	...
	spec("listTransactionStateChanges", "GET", "/transactions/{hash}/state-changes", true,
		pathParameter("hash", ParameterHash),
		cursorParameter(), limitParameter("25")),
	spec("listTransactionAuthorizations", "GET", "/transactions/{hash}/authorizations", true,
		pathParameter("hash", ParameterHash),
		cursorParameter(), limitParameter("25")),
	...
	spec("listAddressTransactions", "GET", "/addresses/{address}/transactions", true,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("25")),
	spec("listAddressUserOperations", "GET", "/addresses/{address}/user-operations", true,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("25")),
	spec("listAddressWithdrawals", "GET", "/addresses/{address}/withdrawals", true,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("25")),
	...
	spec("listAddressNFTBalances", "GET", "/addresses/{address}/nfts", true,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("25")),
	spec("listAddressERC20Balances", "GET", "/addresses/{address}/erc20-balances", true,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("25")),
	...
	spec("getNFTMetadata", "GET", "/nfts/{address}/{token_id}/metadata", true,
		pathParameter("address", ParameterAddress),
		pathParameter("token_id", ParameterUint256)),
	...
	spec("getVerifierJob", "GET", "/verifier/jobs/{id}", true,
		pathParameter("id", ParameterUUID)),
	spec("getVerifiedContract", "GET", "/contracts/{address}/verification", false,
		pathParameter("address", ParameterAddress)),
	spec("getContractProxy", "GET", "/contracts/{address}/proxy", false,
		pathParameter("address", ParameterAddress)),
	spec("listContractProxyUpgrades", "GET", "/contracts/{address}/proxy/upgrades", false,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("20")),
	spec("listContractProxyInitializations", "GET", "/contracts/{address}/proxy/initializations", false,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("20")),
	spec("listContractDiamondCuts", "GET", "/contracts/{address}/proxy/diamond-cuts", false,
		pathParameter("address", ParameterAddress),
		cursorParameter(), limitParameter("20")),
