...
var catalog = []Spec{
	...
	spec("submitVerificationJob", "POST", "/verification/jobs", false),
	spec("getVerificationJob", "GET", "/verification/jobs/{id}", true,
		pathParameter("id", ParameterUUID)),
	spec("getVerifiedContract", "GET", "/contracts/{address}/verification", true,
		pathParameter("address", ParameterAddress),
		requiredQueryParameter("code_hash", ParameterHash)),
	spec("lookupSourcifyContract", "GET", "/sourcify/contracts/{address}", true,
		pathParameter("address", ParameterAddress)),
	spec("importSourcifyContract", "POST", "/sourcify/imports", false),
	spec("uploadVerificationJobToSourcify", "POST", "/verification/jobs/{id}/sourcify", false,
		pathParameter("id", ParameterUUID)),
	spec("getSourcifyJob", "GET", "/sourcify/jobs/{verification_id}", true,
		pathParameter("verification_id", ParameterUUID)),
}
