...
var catalog = []Spec{
	...
	billable("account", "txsBeaconWithdrawal"),
	billable("account", "addresstokenbalance"),
	billable("account", "addresstokennftbalance"),
	billable("account", "addresstokennftinventory"),
	billable("account", "fundedby"),
	...
	billable("block", "getblocktxnscount"),
