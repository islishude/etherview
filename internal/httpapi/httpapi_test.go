...
func TestRoutePatternUsesRegisteredMuxPatternsAndBoundsCatchAll(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPost, "/api/v1/contracts/0xsecret/verification", "", "/api/v1/contracts/{address}/verification"},
		{http.MethodGet, "/api/v1/verifier/jobs/job-secret", "", "/api/v1/verifier/jobs/{id}"},
		...
		{http.MethodPost, "/api/v1/verifier/lookup-methods", "", "/api/v1/verifier/lookup-methods"},
		{http.MethodPost, "/api/v1/verifier/sourcify", "", "/api/v1/verifier/sourcify"},
		...
		{http.MethodGet, "/api/v1/verifier/lookup-methods", "", "method_not_allowed"},
