...
func verificationCompiler(
	...
	return verify.NewCompilerRouter(solcJS, geas, &verify.VyperCompiler{Catalog: catalog, Cache: solcJS.Cache, Timeout: cfg.Verification.Timeout, MaxInputBytes: cfg.Verification.MaxInputBytes, MaxOutputBytes: cfg.Verification.MaxOutputBytes})
}
